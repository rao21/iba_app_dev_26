...
/// GET, POST, PATCH, DELETE — coloured the way every API tool colours them,
/// so the colour becomes a vocabulary word before the student reads a line
/// of code. Deliberately outside the app's theme: this is a fixed
/// convention, not a design choice per screen.
